      ...
      <DialogContent onClose={() => handleOpenChange(false)}>
          ...
          <div className="space-y-2">
            ...
            {mode === 'save' && (
              <p className="text-xs text-muted-foreground">
                Thao tác này sẽ lưu thông tin đăng nhập hiện tại của bạn thành
                một hồ sơ có tên. Bạn có thể chuyển đổi lại sau này.
              </p>
            )}
          </div>
        </div>
        ...
        <DialogFooter>
          ...
          <Button
            ...
            disabled={saving}
          >
            {saving ? 'Đang lưu...' : mode === 'save' ? 'Lưu Hồ sơ' : 'Đổi tên'}
          </Button>
        </DialogFooter>
      </DialogContent>
    </Dialog>
