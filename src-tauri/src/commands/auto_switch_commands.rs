...
use crate::auto_switch::{store, AutoSwitchConfig, AutoSwitchLogPage};
...
/// One page of automatic-switch activity, newest entry first.
#[tauri::command]
pub async fn get_auto_switch_history(
    app: AppHandle,
    offset: usize,
    limit: usize,
) -> AutoSwitchLogPage {
    store::history_page(&app, offset, limit)
}
