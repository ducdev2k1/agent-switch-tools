...
_The v1.0.3 update brings the flavor of a true professional management utility: silently intelligent, deeply polished in its UI, and precise right down to the metadata layer._
