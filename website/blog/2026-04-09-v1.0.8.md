...
- **Gộp vào Webhook chính:** Session token usage giờ được gửi chung trong payload webhook — chỉ cần 1 URL duy nhất. Chọn khoảng thời gian (1h, 5h, 24h, 7d) và mức chi tiết (summary/detailed) trong cài đặt webhook.
