---
slug: v1.0.14
title: Agent Switch Tools v1.0.14
authors: [ducdev2k1]
tags: [release, bugfix, token, changelog]
date: 2026-06-30
---
...
### 4. Hướng dẫn "Phiên tự động" ngay trong app

Tab **Phiên tự động** giờ có phần **giải thích tính năng và cách dùng** ngay trên giao diện: tính năng này tự "mở" cửa sổ hạn mức 5 giờ của Claude vào đúng giờ bạn chọn mỗi ngày, để cửa sổ trùng với giờ làm việc và không bị lãng phí. Xem chi tiết tại [Tính năng → Phiên tự động](/docs/tinh-nang).
...
- Làm mới token cho tài khoản đã lưu (chưa active) ghi đúng vào kho riêng của tài khoản đó, không ảnh hưởng tài khoản đang dùng.
